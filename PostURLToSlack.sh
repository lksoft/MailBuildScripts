...
MESSAGE_STRING="*$BUILD_TYPE* $MAIN_PRODUCT_NAME build - $VERSION $BUILD_NUM[$GIT_BRANCH/$GIT_HASH]: https://s3.amazonaws.com/media.smallcubed.com/$SUB_PATH/$PRODUCT_CODE/$MAIN_PRODUCT_NAME.$VERSION.dmg"
